...
2) Go to the `Data Science Projects` section and access your application's project named `ai-rhdh-app-development`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-1731318094888-notebook`.
...
5) In the terminal, run `cd chatbot-1731318094888` to navigate to your sample app's directory.
